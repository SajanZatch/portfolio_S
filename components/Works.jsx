  ...
  return (
    ...
    >
      <Tilt
        tiltMaxAngleX="10"
        tiltMaxAngleY="10"
        className="dark:bg-bgSecondaryDark bg-bgSecondaryLight p-5 rounded-2xl sm:w-[570px] w-full h-fit min-h-[650px] shadow-sm shadow-primary"
      >
        ...
        {howItWorks && (
          <div className="mt-4">
            <h4 className="dark:text-ctnPrimaryDark text-ctnPrimaryLight font-semibold text-[16px] mb-2">
              How It Works:
            </h4>
            <ul className="list-disc list-inside space-y-1">
              {howItWorks.map((item, idx) => (
                <li
                  key={idx}
                  className="dark:text-ctnSecondaryDark text-ctnSecondaryLight text-[13px] leading-relaxed"
                >
                  {item}
                </li>
              ))}
    ...
    <section className="xl:my-36 md:mx-36 p-8 " id="projects">
      ...
      <div className="w-full flex">
        <motion.p
          ...
          viewport={{ once: true, amount: 0.25 }}
        >
          These projects showcase my practical skills and experience. They
