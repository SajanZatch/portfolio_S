...
export default function App({ Component, pageProps }) {
	...
	const title = "Portfolio | Snigdharani Das";
	const description =
		"Hello! I'm Snigdharani Das, HR professional and problem solver. Welcome to my portfolio";
	// const avatar =
		...
		<>
			<Head>
				...
				<link
					...
					sizes="180x180"
					href="/assets/icons/favicon/apple-touch-icon.jpg"
				/>
				<link
					rel="icon"
					type="image/png"
					sizes="32x32"
					href="/assets/icons/favicon/favicon-32x32.jpg"
				/>
				<link
					rel="icon"
					type="image/png"
					sizes="16x16"
					href="/assets/icons/favicon/favicon-16x16.jpg"
				/>
				<link
					rel="manifest"
